...
public class MineOpusAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        Picasso.with(context).load("file://"+bean.getHead()).placeholder(R.mipmap.health_guide_woman_selected).resize(80,80).transform(new CircleTrans()).centerCrop().into(holder.head);
